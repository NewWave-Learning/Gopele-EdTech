...
export function AIMentor({ onNavigate, data }: AIMentorProps) {
  return (
    <div className="bg-white h-[1733px] overflow-clip relative w-[1440px]" data-name="AI Mentor">
      {/* Nav Bar */}
      <div className="absolute h-[80px] left-0 shadow-[0px_2px_4px_0px_rgba(0,0,0,0.25)] top-0 w-[1440px]" data-name="Nav Bar">
        ...
        <div className="absolute contents" data-name="Nav Links">
          ...
          {/* AI Mentor active indicator - 9% width, centered under AI Mentor */}
          <div className="absolute bg-[rgba(31,96,216,0.4)] inset-[56.55%_29.5%_32.85%_61.5%] rounded-[8.478px]" />
          
          {/* AI Mentor - left: 60%, width: 12%, right: 28% */}
          <button 
            className="absolute font-['Poppins:SemiBold',_sans-serif] inset-[30.05%_28%_27.55%_60%] leading-[33.913px] not-italic text-[#333333] text-[21.196px] text-center cursor-pointer"
          >
            AI Mentor
          </button>
      ...
      <div className="absolute bg-[#1f60d8] h-[365px] left-0 overflow-clip rounded-[8px] top-[80px] w-[1440px]" data-name="Meet Wall-E">
        ...
        <div className="absolute contents left-[163px] top-[79px]" data-name="Walle Intro">
          <button className="absolute bg-[#f4d35e] box-border content-stretch flex gap-[7px] h-[48px] items-center left-[163px] px-[12px] py-[7px] rounded-[8px] top-[238px] cursor-pointer hover:bg-[#f9d977] transition-colors" data-name="Button">
            <p className="font-['Poppins:SemiBold',_sans-serif] leading-[normal] not-italic relative shrink-0 text-[#232323] text-[18px] text-nowrap whitespace-pre">See Recommendations</p>
          </button>
      ...
      <div className="absolute contents left-[160px] top-[525px]" data-name="Spaced Repetition">
        ...
        <div className="absolute bg-[#1f60d8] h-[361px] left-[160px] overflow-clip rounded-[8px] top-[605px] w-[1120px]" data-name="Spaced Repetition">
          ...
          <div className="absolute h-[50.021px] left-[54px] top-[20px] w-[601px]" data-name="Repetition Chain">
          ...
          <div className="absolute content-stretch flex gap-[18px] items-center left-[36px] top-[289px] w-[328px]" data-name="Buttons">
            <button className="bg-[#f4d35e] box-border content-stretch flex gap-[7px] h-[48px] items-center justify-center px-[12px] py-[7px] relative rounded-[8px] shrink-0 w-[155px] cursor-pointer hover:bg-[#f9d977] transition-colors" data-name="Button">
            ...
            <button className="bg-white box-border content-stretch flex gap-[7px] h-[48px] items-center justify-center px-[12px] py-[7px] relative rounded-[8px] shrink-0 w-[155px] cursor-pointer hover:bg-gray-100 transition-colors" data-name="Button">
      ...
      <div className="absolute contents left-[160px] top-[1026px]" data-name="Recommend Topics">
        ...
        <div className="absolute contents left-[1153px] top-[1039px]" data-name="Arrow Buttons">
          <button className="absolute left-[1153px] size-[49px] top-[1039px] cursor-pointer hover:opacity-80 transition-opacity" data-name="Arrow Slider Left">
          ...
          <button className="absolute left-[1235px] size-[49px] top-[1039px] cursor-pointer hover:opacity-80 transition-opacity" data-name="Arrow Slider Right">
            <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 49 49">
              ...
              <div className="content-stretch flex gap-[18px] items-center relative shrink-0 w-[328px]" data-name="Buttons">
                ...
                <button className="bg-white box-border content-stretch flex gap-[7px] h-[48px] items-center justify-center px-[12px] py-[7px] relative rounded-[8px] shrink-0 w-[155px] cursor-pointer hover:bg-gray-100 transition-colors" data-name="Button">
                  <div className="relative shrink-0 size-[30px]" data-name="Solid/Status/Bookmark">
                    <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 30 30">
                      <g id="Solid/Status/Bookmark">
                        <path d={svgPaths.p88e6270} fill="var(--fill-0, #232323)" fillOpacity="1" id="Icon" stroke="var(--stroke-0, #232323)" strokeWidth="3" />
                      </g>
                    </svg>
                  </div>
                  <div className="flex flex-col font-['Poppins:Medium',_sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#232323] text-[18px] text-nowrap">
