import svgPaths from "./svg-8epbno2mh0";
...
function SolidInterfaceEditAlt1() {
  return (
    <div className="absolute left-[426px] size-[40px] top-[923px]" data-name="Solid/Interface/Edit-alt">
...
function Button3() {
  return (
    <div className="absolute bg-[#1f60d8] box-border content-stretch flex gap-[7px] h-[48px] items-center justify-center left-[1071px] pl-[19px] pr-[18px] py-[7px] rounded-[8px] top-[836px] w-[209px]" data-name="Button">
...
function Frame258() {
  return (
    <div className="absolute h-[315px] left-[122px] rounded-[6px] top-[996px] w-[274px]">
  ...
  return (
    <div className="bg-white relative size-full" data-name="Empty Subject">
      ...
      <div className="absolute flex flex-col font-['Poppins:SemiBold',_sans-serif] justify-center leading-[0] left-[122px] not-italic text-[32px] text-black text-nowrap top-[943px] translate-y-[-50%]">
        <p className="leading-[42px] whitespace-pre">Molecular Biology</p>
      </div>
      <Button3 />
      <Frame258 />
    </div>
