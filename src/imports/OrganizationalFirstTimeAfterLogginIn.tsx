import svgPaths from "./svg-rm3h8ylet9";
...
function Button() {
  return (
    <div className="absolute bg-[#1f60d8] box-border content-stretch flex gap-[5.331px] h-[49px] items-center justify-center left-[890px] opacity-50 pl-[9px] pr-[13.709px] py-[5.331px] rounded-[10px] top-[628px] w-[393px]" data-name="Button">
...
function Password() {
  return (
    <div className="absolute contents left-[890px] top-[477px]" data-name="password">
      <EmailInput />
      <p className="absolute font-['Poppins:Light',_sans-serif] leading-[24px] left-[1145px] not-italic text-[#9b9b9b] text-[14px] text-nowrap top-[576px] whitespace-pre">forgot password ?</p>
      <Group11712 />
      <Group11713 />
    </div>
  );
...
function EmailInput1() {
  return (
    <div className="absolute contents left-[890px] top-[371px]" data-name="Email Input">
      ...
      <p className="absolute font-['Poppins:Regular',_sans-serif] h-[36.391px] leading-[31px] left-[912.63px] not-italic text-[#c6d5de] text-[16px] top-[414.56px] w-[223.891px]">admin@organization.com</p>
      <p className="absolute font-['Poppins:Medium',_sans-serif] leading-[31px] left-[896px] not-italic text-[#1b1616] text-[16px] text-nowrap top-[371px] whitespace-pre">Email</p>
    </div>
  );
}

export default function OrganizationalFirstTimeAfterLogginIn() {
  return (
    <div className="bg-white relative size-full" data-name="Organizational - first time after loggin in">
