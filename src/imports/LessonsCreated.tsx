import svgPaths from "./svg-pabwcoljth";
...
function Button3() {
  return (
    <div className="absolute bg-[#1f60d8] box-border content-stretch flex gap-[7px] h-[48px] items-center justify-center left-[1088px] pl-[19px] pr-[18px] py-[7px] rounded-[8px] top-[814px] w-[209px]" data-name="Button">
...
export default function LessonsCreated() {
  return (
    <div className="bg-white relative size-full" data-name="Lessons Created">
      <SubjectDetails />
      <NavBarTeachers />
      <Button3 />
    </div>
