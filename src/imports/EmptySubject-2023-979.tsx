import svgPaths from "./svg-cct1o3j1rc";
...
function TextField() {
  return (
    <div className="absolute bg-white h-[52.749px] left-[69px] rounded-[6.594px] top-[183px] w-[583px]" data-name="Text field">
...
function TextArea() {
  return (
    <div className="absolute contents left-[69px] top-[183px]" data-name="Text Area">
      <TextField />
    </div>
  );
}
...
function Button3() {
  return (
    <div className="absolute bg-[#1f60d8] box-border content-stretch flex gap-[7px] h-[48px] items-center justify-center left-[274px] pl-[19px] pr-[18px] py-[7px] rounded-[8px] top-[427px] w-[209px]" data-name="Button">
...
function Button4() {
  return (
    <div className="absolute bg-[#f03b13] box-border content-stretch flex gap-[7px] h-[48px] items-center justify-center left-[499px] pl-[19px] pr-[18px] py-[7px] rounded-[8px] top-[427px] w-[153px]" data-name="Button">
...
function Frame11() {
  return (
    <div className="absolute h-[52px] right-[61px] rounded-[10px] top-[282px] w-[583px]">
      ...
      <Button5 />
      <p className="absolute font-['Poppins:Medium',_sans-serif] leading-[24px] left-[18px] not-italic text-[15px] text-[rgba(35,35,35,0.6)] text-nowrap top-[14px] whitespace-pre">No file uploaded</p>
    </div>
  );
}
...
function Frame261() {
  return (
    <div className="absolute bg-white h-[528px] left-[363px] overflow-clip rounded-[30px] top-[579px] w-[713px]">
...
export default function EmptySubject() {
  return (
    <div className="bg-white relative size-full" data-name="Empty Subject">
      <SubjectDetails />
      <NavBarTeachers />
      <div className="absolute bg-[#0b0c0c] h-[1567px] left-0 opacity-60 top-0 w-[1440px]" />
      <Frame261 />
    </div>
  );
}