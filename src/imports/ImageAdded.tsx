import svgPaths from "./svg-2rb2upb9o6";
      ...
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 42 42">
        <g id="Arrow Slider Left">
          ...
          <g id="Solid/Interface/Arrow left">
            <path d={svgPaths.p4d9c800} fill="var(--fill-0, #232323)" id="Icon" />
          </g>
        </g>
      </svg>
    </div>
...
function Frame20() {
  return (
    <div className="absolute content-stretch flex gap-[5px] inset-[14.6%_6.94%_83.21%_80.97%] items-center justify-end">
      <UCheck />
...
function Radio() {
  return (
    <div className="bg-white relative rounded-[82.778px] shrink-0 size-[24.833px]" data-name="Radio">
      <div aria-hidden="true" className="absolute border-[#face55] border-[4.967px] border-solid inset-0 pointer-events-none rounded-[82.778px]" />
    </div>
  );
}
...
function RadioWithLabel() {
  return (
    <div className="content-stretch flex gap-[29.8px] h-[24.833px] items-center overflow-clip relative shrink-0" data-name="Radio with label">
      <Radio />
      <p className="font-['Poppins:Medium',_sans-serif] leading-[24.833px] not-italic relative shrink-0 text-[16.556px] text-nowrap text-white whitespace-pre">Unoccupid space beyond earth</p>
    </div>
  );
}
...
function Radio1() {
  return (
    <div className="bg-white relative rounded-[82.778px] shrink-0 size-[24.833px]" data-name="Radio">
      <div aria-hidden="true" className="absolute border-[#232323] border-[1.656px] border-solid inset-0 pointer-events-none rounded-[82.778px]" />
    </div>
  );
}
...
function RadioWithLabel1() {
  return (
    <div className="content-stretch flex gap-[29.8px] h-[24.833px] items-center overflow-clip relative shrink-0" data-name="Radio with label">
      <Radio1 />
      <p className="font-['Poppins:Medium',_sans-serif] leading-[24.833px] not-italic relative shrink-0 text-[16.556px] text-nowrap text-white whitespace-pre">Fames varius semper est vestibulum</p>
    </div>
  );
}
...
function RadioWithLabel2() {
  return (
    <div className="content-stretch flex gap-[29.8px] h-[24.833px] items-center overflow-clip relative shrink-0" data-name="Radio with label">
      <Radio2 />
      <p className="font-['Poppins:Medium',_sans-serif] leading-[24.833px] not-italic relative shrink-0 text-[16.556px] text-nowrap text-white whitespace-pre">Fusce donec orci semper cras</p>
    </div>
  );
}
...
function RadioWithLabel3() {
  return (
    <div className="content-stretch flex gap-[29.8px] h-[24.833px] items-center overflow-clip relative shrink-0" data-name="Radio with label">
      <Radio3 />
      <p className="font-['Poppins:Medium',_sans-serif] leading-[24.833px] not-italic relative shrink-0 text-[16.556px] text-nowrap text-white whitespace-pre">Velit tempus quam ac nec</p>
    </div>
  );
}
...
function Button1() {
  return (
    <div className="absolute bg-white box-border content-stretch flex gap-[5.794px] h-[39.733px] items-center left-[214.39px] px-[9.933px] py-[5.794px] rounded-[6.622px] top-[269.03px]" data-name="Button">
    ...
    <div className="relative shrink-0 size-[24.833px]" data-name="Solid/Status/Checked-box">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 25 25">
        <g id="Solid/Status/Checked-box">
          <path d={svgPaths.p3516800} fill="var(--fill-0, #232323)" id="Icon" />
        </g>
      </svg>
    </div>
  );
...
function Button2() {
  return (
    <div className="absolute bg-[#f4d35e] box-border content-stretch flex gap-[5.794px] h-[39.733px] items-center left-[28.97px] px-[9.933px] py-[5.794px] rounded-[6.622px] top-[269.03px]" data-name="Button">
...
function ActivityMcq() {
  return (
    <div className="absolute bg-[#1f60d8] h-[332px] left-[823px] overflow-clip rounded-[6.622px] top-[293px] w-[520px]" data-name="Activity: MCQ">
      <McqLogo />
      <p className="absolute font-['Poppins:SemiBold',_sans-serif] leading-[24.833px] left-[91.06px] not-italic text-[23.178px] text-nowrap text-white top-[25.66px] whitespace-pre">What is Space?</p>
      <RadioButtonGroup />
      <Buttons />
    </div>
  );
...
function Group11869() {
  return (
    <div className="absolute contents left-[823px] top-[236px]">
      <div className="absolute bottom-[837px] flex flex-col font-['Poppins:SemiBold',_sans-serif] justify-center leading-[0] left-[827px] not-italic text-[#232323] text-[24px] text-nowrap translate-y-[50%]">
...
function ImageWithCaption() {
  return (
    <div className="absolute contents left-[33px] top-[144px]" data-name="Image with Caption">
      <div className="absolute h-[369.549px] left-[33px] rounded-[8px] top-[144px] w-[584.648px]" data-name="unsplash:0o_GEzyargo">
      ...
      <p className="absolute font-['Poppins:Medium',_sans-serif] h-[19px] leading-[26px] left-[33px] not-italic text-[#9b9b9b] text-[14px] top-[518px] w-[261px]">A cluster of stars. Source: Unsplash</p>
    </div>
  );
}
...
function TextField() {
  return (
    <div className="absolute bg-white h-[560px] left-[86px] rounded-[6.594px] top-[456px] w-[721px]" data-name="Text field">
      <div className="h-[560px] overflow-clip relative rounded-[inherit] w-[721px]">
...
function TextArea() {
  return (
    <div className="absolute contents left-[86px] top-[456px]" data-name="Text Area">
      <TextField />
    </div>
  );
}
...
function Frame14() {
  return (
    <div className="absolute bg-white box-border content-stretch flex flex-col gap-[10px] items-start left-[484px] px-[9px] py-[8px] rounded-[5.185px] shadow-[0px_0px_5.185px_1.037px_rgba(0,0,0,0.23)] top-[404px]">
      <Frame13 />
    </div>
  );
}
...
function Group11868() {
  return (
    <div className="absolute contents left-[84px] top-[404px]">
      <div className="absolute bottom-[669px] flex flex-col font-['Poppins:SemiBold',_sans-serif] justify-center leading-[0] left-[84px] not-italic text-[#232323] text-[24px] text-nowrap translate-y-[50%]">
...
function Group11860() {
  return (
    <div className="absolute contents left-[84px] top-[241px]">
      <div className="absolute bottom-[737px] flex flex-col font-['Poppins:Medium',_sans-serif] justify-center leading-[0] left-[84px] not-italic text-[#9b9b9b] text-[13.535px] text-nowrap translate-y-[50%]">
        <p className="leading-[25.622px] whitespace-pre">Max Char 40</p>
      </div>
      <div className="absolute bottom-[832px] flex flex-col font-['Poppins:SemiBold',_sans-serif] justify-center leading-[0] left-[84px] not-italic text-[#232323] text-[24px] text-nowrap translate-y-[50%]">
...
export default function ImageAdded() {
  return (
    <div className="bg-white relative size-full" data-name="Image Added">
      <NavBarTeachers />
      <BackNav />
      <Frame20 />
      <Group11869 />
