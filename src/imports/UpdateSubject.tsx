import svgPaths from "./svg-nowuxjzzbl";
  ...
  return (
    <div className="absolute bg-white h-[52.749px] left-[784px] rounded-[6.594px] top-[266px] w-[583px]" data-name="Text field">
      <div className="h-[52.749px] overflow-clip relative rounded-[inherit] w-[583px]">
        <div className="absolute flex flex-col font-['Poppins:Medium',_sans-serif] justify-center leading-[0] left-[15.66px] not-italic text-[#232323] text-[16.484px] text-nowrap top-[24.86px] translate-y-[-50%]">
          <p className="leading-[24.726px] whitespace-pre">Science</p>
        </div>
      </div>
  ...
  return (
    <div className="absolute bg-white h-[161px] left-[782px] rounded-[6.594px] top-[413px] w-[583px]" data-name="Text field">
      <div className="h-[161px] overflow-clip relative rounded-[inherit] w-[583px]">
        <div className="absolute flex flex-col font-['Poppins:Medium',_sans-serif] justify-center leading-[normal] left-[16px] not-italic text-[16.484px] text-[rgba(35,35,35,0.6)] top-[143px] translate-y-[-50%] w-[545px]">
...
function Frame12() {
  return (
    <div className="absolute h-[52px] right-[73px] rounded-[10px] top-[789px] w-[583px]">
      <div aria-hidden="true" className="absolute border-[#0b0c0c] border-[1.65px] border-solid inset-0 pointer-events-none rounded-[10px]" />
      <Button1 />
      <p className="absolute font-['Poppins:Medium',_sans-serif] leading-[24px] left-[18px] not-italic text-[15px] text-black text-nowrap top-[14px] whitespace-pre">banner.png</p>
    </div>
  );
}
...
export default function UpdateSubject() {
  return (
    <div className="bg-white relative size-full" data-name="Update Subject">
      <BackNav />
