import svgPaths from "./svg-mpjh24u71k";
...
function Button() {
  return (
    <div className="absolute bg-[#1f60d8] box-border content-stretch flex gap-[5.331px] h-[49px] items-center justify-center left-[524px] pl-[9px] pr-[13.709px] py-[5.331px] rounded-[10px] top-[559px] w-[393px]" data-name="Button">
    ...
    <div className="absolute contents left-[532px] top-[388px]">
      <div className="absolute flex flex-col font-['Poppins:SemiBold',_sans-serif] justify-center leading-[0] left-[720px] not-italic text-[35px] text-black text-center text-nowrap top-[412px] translate-x-[-50%] translate-y-[-50%]">
        <p className="leading-[48px] whitespace-pre">
          <span className="text-[#0b0c0c]">Congratulation</span>,<span className="text-[#1f60d8]">{` Seev`}</span>
        </p>
      </div>
    </div>
  );
...
export default function OrganizationalFirstTimeAfterLogginCongratulationDfs() {
  return (
    <div className="bg-white relative size-full" data-name="Organizational - first time after loggin - Congratulation, DFS">
      <Logo />
      <Group11736 />
    </div>
  );
