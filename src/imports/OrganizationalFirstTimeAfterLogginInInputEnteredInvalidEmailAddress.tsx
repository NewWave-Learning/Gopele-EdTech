import svgPaths from "./svg-9qu0p59eu6";
...
function Button() {
  return (
    <div className="absolute bg-[#1f60d8] box-border content-stretch flex gap-[5.331px] h-[49px] items-center justify-center left-[890px] pl-[9px] pr-[13.709px] py-[5.331px] rounded-[10px] top-[646px] w-[393px]" data-name="Button">
...
function EmailInput() {
  return (
    <div className="absolute contents left-[890px] top-[495px]" data-name="Email Input">
      <div className="absolute bg-white h-[54px] left-[890px] rounded-[10px] top-[528px] w-[393px]">
      ...
      <p className="absolute font-['Poppins:Medium',_sans-serif] leading-[31px] left-[896px] not-italic text-[#1b1616] text-[16px] text-nowrap top-[495px] whitespace-pre">Password</p>
    </div>
  );
}
...
function Group11712() {
  return (
    <div className="absolute h-[11.59px] left-[913px] top-[549.21px] w-[101px]">
...
function Group11713() {
  return (
    <div className="absolute inset-[63.99%_12.27%_34.27%_86.6%]">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 17 15">
        <g id="Group 11713">
          <path d={svgPaths.p27c06e00} fill="var(--fill-0, #0B0C0C)" id="Vector" />
        </g>
      </svg>
    </div>
  );
...
function Password() {
  return (
    <div className="absolute contents left-[890px] top-[495px]" data-name="password">
      <EmailInput />
      <p className="absolute font-['Poppins:Light',_sans-serif] leading-[24px] left-[1158px] not-italic text-[#9b9b9b] text-[14px] text-nowrap top-[594px] whitespace-pre">forgot password ?</p>
      <Group11712 />
      <Group11713 />
    </div>
  );
  ...
  return (
    <div className="absolute contents left-[890px] top-[371px]" data-name="Email Input">
      <div className="absolute bg-white h-[54px] left-[890px] rounded-[10px] top-[404px] w-[393px]">
        <div aria-hidden="true" className="absolute border border-[rgba(255,102,68,0.5)] border-solid inset-[-1px] pointer-events-none rounded-[11px]" />
      </div>
      <p className="absolute font-['Poppins:Regular',_sans-serif] h-[36.391px] leading-[31px] left-[912.63px] not-italic text-[#0b0c0c] text-[16px] top-[414.56px] w-[223.891px]">admin@playn.com</p>
      <p className="absolute font-['Poppins:Regular',_sans-serif] h-[24px] leading-[31px] left-[890px] not-italic text-[#ff6644] text-[12px] top-[460px] w-[224px]">Invalid email address</p>
...
export default function OrganizationalFirstTimeAfterLogginInInputEnteredInvalidEmailAddress() {
  return (
    <div className="bg-white relative size-full" data-name="Organizational - first time after loggin in - Input entered - Invalid email address">
