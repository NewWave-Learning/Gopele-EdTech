import svgPaths from "./svg-0e32ceu5ee";
...
function Button() {
  return (
    <div className="absolute bg-[#1f60d8] box-border content-stretch flex gap-[5.331px] h-[49px] items-center justify-center left-[890px] pl-[9px] pr-[13.709px] py-[5.331px] rounded-[10px] top-[628px] w-[393px]" data-name="Button">
...
function Group11712() {
  return (
    <div className="absolute h-[11.59px] left-[913px] top-[531.21px] w-[83.787px]">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 84 12">
        <g id="Group 11712">
          ...
          <g id="Group 11711">
            ...
            <circle cx="77.9918" cy="5.79508" fill="var(--fill-0, #0B0C0C)" id="Ellipse 88" r="5.79508" />
          </g>
        </g>
      </svg>
    </div>
...
function Group11713() {
  return (
    <div className="absolute inset-[61.89%_12.27%_36.36%_86.6%]">
...
function Password() {
  return (
    <div className="absolute contents left-[890px] top-[477px]" data-name="password">
      <EmailInput />
      <p className="absolute font-['Poppins:Light',_sans-serif] leading-[24px] left-[1158px] not-italic text-[#9b9b9b] text-[14px] text-nowrap top-[576px] whitespace-pre">forgot password ?</p>
      <Group11712 />
      <Group11713 />
    </div>
  );
...
function EmailInput1() {
  return (
    <div className="absolute contents left-[890px] top-[371px]" data-name="Email Input">
      ...
      <p className="absolute font-['Poppins:Regular',_sans-serif] h-[36.391px] leading-[31px] left-[912.63px] not-italic text-[#0b0c0c] text-[16px] top-[414.56px] w-[223.891px]">admin@organization.com</p>
...
export default function OrganizationalFirstTimeAfterLogginInInputEnteredInvalidPassword() {
  return (
    <div className="bg-white relative size-full" data-name="Organizational - first time after loggin in - Input entered- Invalid password">
      ...
      <p className="absolute font-['Poppins:Regular',_sans-serif] h-[24px] leading-[31px] left-[890px] not-italic text-[#ff6644] text-[12px] top-[571px] w-[224px]">Invalid password</p>
    </div>
  );
}