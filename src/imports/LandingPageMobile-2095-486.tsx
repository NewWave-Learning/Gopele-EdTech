import svgPaths from "./svg-wjke1rjq0o";
...
import { imgPlantLeft } from "./svg-z3afk";
...
function WalleIntro() {
  return (
    <div className="absolute contents left-[21px] top-[115px]" data-name="Walle Intro">
      ...
      <div className="absolute flex flex-col font-['Poppins:Medium',sans-serif] inset-[1.89%_10.4%_95.71%_5.6%] justify-center leading-[0] not-italic text-[40px] text-white">
...
function DarkFieldDefault() {
  return (
    <div className="absolute h-[76px] left-[42px] top-[883px] w-[201px]" data-name="Dark/Field/Default">
      ...
      <p className="absolute font-['DM_Sans:Regular',sans-serif] font-normal leading-[32px] left-[16px] text-[16px] text-[rgba(51,51,51,0.5)] text-nowrap top-[37px] whitespace-pre" style={{ fontVariationSettings: "'opsz' 14" }}>
        Placeholder
      </p>
    </div>
  );
