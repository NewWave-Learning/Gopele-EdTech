import svgPaths from "./svg-61w1qlkmn1";

function Button() {
  return (
    <div className="absolute bg-[#1f60d8] box-border content-stretch flex gap-[5.331px] h-[49px] items-center justify-center left-[524px] pl-[9px] pr-[13.709px] py-[5.331px] rounded-[10px] top-[615px] w-[393px]" data-name="Button">
...
function Group11712() {
  return (
    <div className="absolute contents left-[547px] top-[399.2px]">
      <Group11741 />
    </div>
  );
}
...
function EmailInput1() {
  return (
    <div className="absolute contents left-[524px] top-[463px]" data-name="Email Input">
...
function Group11716() {
  return (
    <div className="absolute inset-[60.26%_37.68%_37.99%_61.18%]">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 17 15">
        <g id="Group 11713">
          <path d={svgPaths.p21dd0600} fill="var(--fill-0, black)" id="Vector" />
        </g>
...
function Password1() {
  return (
    <div className="absolute contents left-[524px] top-[463px]" data-name="password">
      <EmailInput1 />
      <Group11715 />
      <Group11716 />
    </div>
...
export default function OrganizationalFirstTimeAfterLogginSetAPassword() {
  return (
    <div className="bg-white relative size-full" data-name="Organizational - first time after loggin - Set a Password">
      <Button />
      ...
      <p className="absolute font-['Poppins:Regular',_sans-serif] h-[24px] leading-[31px] left-[524px] not-italic text-[#ff6644] text-[12px] top-[550px] w-[224px]">Password does not match</p>
    </div>
  );
}