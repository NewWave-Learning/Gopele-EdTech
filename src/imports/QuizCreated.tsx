import svgPaths from "./svg-7ehevn8p09";
...
function Group11868() {
  return (
    <div className="absolute contents left-[84px] top-[394px]">
      <div className="absolute bottom-[607px] flex flex-col font-['Poppins:SemiBold',_sans-serif] justify-center leading-[0] left-[84px] not-italic text-[#232323] text-[24px] text-nowrap translate-y-[50%]">
...
function Group11860() {
  return (
    <div className="absolute contents left-[84px] top-[241px]">
      <div className="absolute bottom-[665px] flex flex-col font-['Poppins:Medium',_sans-serif] justify-center leading-[0] left-[84px] not-italic text-[#9b9b9b] text-[13.535px] text-nowrap translate-y-[50%]">
...
export default function QuizCreated() {
  return (
    <div className="bg-white relative size-full" data-name="Quiz Created">
      <NavBarTeachers />
      <BackNav />
      <Frame20 />
      <Group11869 />
