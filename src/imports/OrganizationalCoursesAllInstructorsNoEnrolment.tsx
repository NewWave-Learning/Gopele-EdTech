import svgPaths from "./svg-gpwc6h2mrb";
import imgRectangle18391 from "figma:asset/1634068e9d88fb0d93578a09cee3797f774409eb.png";
import { imgGroup11828, imgGroup11829 } from "./svg-s8jux";

function Group11942() {
  return (
    <div className="absolute contents leading-[0] left-[585px] not-italic text-center top-[394px]">
      <div className="absolute flex flex-col font-['Poppins:Regular',_sans-serif] justify-center left-[806px] text-[#1f60d8] text-[16px] top-[516px] translate-x-[-50%] translate-y-[-50%] w-[222px]">
...
function Frame6962() {
  return <div className="absolute h-[69px] left-[11px] top-[303px] w-[212px]" />;
}

function Frame6963() {
  return (
    <div className="absolute h-[69px] left-[11px] top-[242px] w-[212px]">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 212 69">
        <g id="Frame 6963">
          <path d={svgPaths.p2e035700} fill="var(--fill-0, #1F60D8)" id="Rectangle 18396" />
        </g>
      </svg>
    </div>
  );
...
function Group11849() {
  return (
    <div className="absolute contents left-[11px] top-[143px]">
      <Frame6962 />
      <Frame6963 />
      <Group11848 />
    </div>
...
function Group11846() {
  return (
    <div className="absolute contents left-[39px] top-[265px]">
      <div className="absolute flex flex-col font-['Poppins:SemiBold',_sans-serif] justify-center leading-[0] left-[81px] not-italic text-[14px] text-nowrap text-white top-[276.5px] tracking-[-0.28px] translate-y-[-50%]">
...
export default function OrganizationalCoursesAllInstructorsNoEnrolment() {
  return (
    <div className="bg-white relative size-full" data-name="Organizational -Courses  -  All Instructors- No Enrolment">
      <Nav />
      <SideBar />
